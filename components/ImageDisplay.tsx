...
export function ImageDisplay({
  ...
  return (
    <>
      <div
        className={cn(
          "relative w-full h-full group bg-[var(--card)]",
      ...
      >
        ...
        {image && !failed ? (
          <>
            ...
            {timing?.elapsed && (
              <div className="absolute bottom-2 right-2 backdrop-blur-sm rounded-md px-2 py-1 shadow bg-[var(--foreground)]/70">
      ...
      {isZoomed &&
        ...
        createPortal(
          <div
            className="fixed inset-0 z-50 flex items-center justify-center cursor-pointer min-h-[100dvh] w-screen bg-[var(--foreground)]/90"
